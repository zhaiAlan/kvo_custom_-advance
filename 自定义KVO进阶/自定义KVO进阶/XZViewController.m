...
- (void)viewDidLoad {
    ...
    [self.person xz_addObserver:self forKeyPath:@"nickName" options:(NSKeyValueObservingOptionOld) context:NULL];
    [self.person xz_addObserver:self forKeyPath:@"address" options:(NSKeyValueObservingOptionNew) context:NULL];
